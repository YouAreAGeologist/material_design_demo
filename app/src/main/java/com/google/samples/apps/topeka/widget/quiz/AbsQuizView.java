...
public abstract class AbsQuizView<Q extends Quiz> extends FrameLayout {
    ...
    private void performScoreAnimation(final boolean answerCorrect) {
        ...
        hideFab();
        resizeView();
        ObjectAnimator translateX = ObjectAnimator.ofFloat(mSubmitAnswer, "translationX",-420);
        translateX.setInterpolator(mLinearOutSlowInInterpolator);
        ObjectAnimator translateY = ObjectAnimator.ofFloat(mSubmitAnswer, "translationY",420);
        translateY.setInterpolator(mLinearOutSlowInInterpolator);
        AnimatorSet fm = new AnimatorSet();
        fm.playTogether(translateX, translateY);
        fm.setStartDelay(650);
        fm.setDuration(200);
        fm.setInterpolator(mLinearOutSlowInInterpolator);
        fm.start();
        ObjectAnimator scaleUpX = ObjectAnimator.ofFloat(mSubmitAnswer, "scaleX", 5f);
        ObjectAnimator scaleUpY = ObjectAnimator.ofFloat(mSubmitAnswer, "scaleY", 5f);
        scaleUpX.setInterpolator(mLinearOutSlowInInterpolator);
        scaleUpY.setInterpolator(mLinearOutSlowInInterpolator);
        AnimatorSet scaleUp = new AnimatorSet();
        scaleUp.playTogether(scaleUpX, scaleUpY);
        scaleUp.setDuration(300);
        scaleUp.setStartDelay(750);
        scaleUp.start();
    ...
    private void animateForegroundColor(int targetColor) {
        final ObjectAnimator foregroundAnimator = ObjectAnimator
                .ofArgb(this, FOREGROUND_COLOR, Color.GRAY, targetColor);
        foregroundAnimator
                .setDuration(1000)
                .setInterpolator(mLinearOutSlowInInterpolator);
        foregroundAnimator.setStartDelay(1250);
